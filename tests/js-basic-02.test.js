...
let firstName = 'John';
let lastName = 'Smith';
let message = `Hi, my name is John Smith and I was born in 2001`;
// * Don't mess with the test code below here!
...
let tax = 8.25;
let price = 100;
let total = 'Your total including tax is $108.25';
// * Don't mess with the test code below here!
...
let heading2 = 'HTML';
let html = '<h1>JavaScript</h1><h2>HTML</h2><p>This is a paragraph</p>';
// * Don't mess with the test code below here!
